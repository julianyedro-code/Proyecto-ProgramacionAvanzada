...
public class AlertaStock {
    ...
    public boolean requiereAccionInmediata() {
        return stockActual <= stockMinimoRequerido;
    }

    public Pedido generarRecomendacionPedido() {
    ...
    public void agregarUsuarioNotificado(Usuario usuario) {
        if (usuariosNotificados == null) {
            usuariosNotificados = new ArrayList<>();
        }
